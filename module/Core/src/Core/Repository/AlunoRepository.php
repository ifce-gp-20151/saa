...
class AlunoRepository extends EntityRepository {
    ...
    public function ajaxFindByMatricula($matricula) {
        $dql = "SELECT a.situacaoEscolar, p.nome, c.descricao as curso,
            pe.descricao as periodo
    ...
    public function listar($restricao = null, $offset = 0) {
        ...
        $dql = "SELECT a.matricula, p.nome, c.descricao as curso,
            pe.descricao as periodo, a.situacaoEscolar
            FROM Core\Entity\Aluno a
            JOIN a.idPessoa p
            JOIN a.idCurso c
            JOIN c.idPeriodo pe";
